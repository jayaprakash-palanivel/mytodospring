...
<body>
	...
	<div class="row">
		...
		<div class="container">
			<h3 class="text-center">List of Tasks Based On Project</h3>
			<hr>
				...
				<tbody>
					...
					<c:forEach var="task" items="${listTask}">
						...
						<tr>
							...
							<td><a
								href="editTask?taskId=<c:out value='${task.taskId}' />"><i
									class=" fa fa-edit" style="font-size:20px;color:blue"></i></a> &nbsp;&nbsp;&nbsp;&nbsp;<a
